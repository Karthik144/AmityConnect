...
//                        let newDocument = self.ADLCollectionRef.document(documentId).collection("ADLs").document()
                        ...
                        let dependentDocument = self.ADLCollectionRef.document(documentId).collection("ADLs").document(newDocumentId).collection("ADL").document()
                        
                        // Add this if no activities are selected
                        if finalSelectedList.count <= 0{
                            
                            dependentDocument.setData(["type":"Dependent", "date":dateTimeString, "activity_1": "none"])
                        }
                        
                        // Add this is only one activity is selected
                        if finalSelectedList.count == 1{
                            
                            dependentDocument.setData(["type":"Dependent", "date":dateTimeString, "activity_1": finalSelectedList[0]])
                        }
                        
                        // Add this if two activities are selected
                        if finalSelectedList.count == 2 {
                            
                            dependentDocument.setData(["type":"Dependent", "date":dateTimeString, "activity_1": finalSelectedList[0], "activity_2": finalSelectedList[1]])
                        ...
                        if finalSelectedList.count == 3 {
                            ...
                            dependentDocument.setData(["type":"Dependent", "date":dateTimeString, "activity_1": finalSelectedList[0], "activity_2": finalSelectedList[1], "activity_3":finalSelectedList[2]])
                        ...
                        if finalSelectedList.count == 4 {
                            ...
                            dependentDocument.setData(["type":"Dependent", "date":dateTimeString, "activity_1": finalSelectedList[0], "activity_2": finalSelectedList[1], "activity_3":finalSelectedList[2],"activity_4":finalSelectedList[3]])
                        ...
                        if finalSelectedList.count == 5 {
                            ...
                            dependentDocument.setData(["type":"Dependent", "date":dateTimeString, "activity_1": finalSelectedList[0], "activity_2": finalSelectedList[1], "activity_3":finalSelectedList[2],"activity_4":finalSelectedList[3], "activity_5":finalSelectedList[4]])
                        ...
                        if finalSelectedList.count == 6 {
                            ...
                            dependentDocument.setData(["type":"Dependent", "date":dateTimeString, "activity_1": finalSelectedList[0], "activity_2": finalSelectedList[1], "activity_3":finalSelectedList[2],"activity_4":finalSelectedList[3], "activity_5":finalSelectedList[4], "activity_6":finalSelectedList[5]])
